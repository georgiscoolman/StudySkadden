...
import com.example.isoft.studyskadden.viewHolders.ItemTouchHelperViewHolder;

/**
 * Created by isoft on 13.07.16.
 */
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback  {
    ...
    public SimpleItemTouchHelperCallback(ItemTouchHelperAdapter adapter, WeatherPresenter weatherPresenter) {
        mAdapter = adapter;
